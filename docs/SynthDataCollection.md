...
[INSTALL.md](https://gitlab.com/RuslanAgishev/ImageSynthUnity/-/blob/master/INSTALL.md).
...
The [DataRecorder.cs](https://gitlab.com/RuslanAgishev/ImageSynthUnity/-/blob/master/Assets/Scripts/DataRecorder.cs)
...
[TrainOnSynthDataFastai.ipynb](https://gitlab.com/RuslanAgishev/ImageSynthUnity/-/blob/master/tools/TrainOnSynthDataFastai.ipynb).
...
[TransformMasksToMSeg.ipynb](https://gitlab.com/RuslanAgishev/ImageSynthUnity/-/blob/master/tools/TransformMasksToMSeg.ipynb).
...
[DataRecorder.cs](https://gitlab.com/RuslanAgishev/ImageSynthUnity/-/blob/master/Assets/Scripts/DataRecorder.cs)
...
The file [odometry.json](https://gitlab.com/RuslanAgishev/ImageSynthUnity/-/blob/master/tools/odometry.json)
recorded with the captured frames if Save Frames option of the
[DataRecorder.cs](https://gitlab.com/RuslanAgishev/ImageSynthUnity/-/blob/master/Assets/Scripts/DataRecorder.cs)
is enabled.

Have a look at the
[parse_odometry_and_detections.ipynb](https://gitlab.com/RuslanAgishev/ImageSynthUnity/-/blob/master/tools/parse_odometry_and_detections.ipynb)
...
[DrawLines.cs](https://gitlab.com/RuslanAgishev/ImageSynthUnity/-/blob/master/Assets/DimBoxes/BoundBox/DrawLines.cs)
script is attached to camera for bound boxes visualization in Scene and Game views.
Another script,
[BoundBox.cs](https://gitlab.com/RuslanAgishev/ImageSynthUnity/-/blob/master/Assets/DimBoxes/BoundBox/BoundBox.cs)
...
bbox size, using
[calculateBoundsRelativeToCamera](https://gitlab.com/RuslanAgishev/ImageSynthUnity/-/blob/master/Assets/DimBoxes/BoundBox/BoundBox.cs#L122) function.
